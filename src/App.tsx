  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="absolute bottom-6 end-4 md:bottom-10 md:end-8 text-white text-xs md:text-sm font-semibold z-10">
          {t.heroFreeConsult}
        </span>
      </MaskedCard>
    </section>
  ...
  return (
    ...
    >
      <div className="flex-1 min-h-0 grid grid-cols-1 md:grid-cols-2 grid-rows-[auto_auto_auto_auto] md:grid-rows-[0.9fr_0.9fr_1.3fr] gap-1.5 md:gap-2">
        ...
        >
          <h3 className="absolute top-4 start-5 md:top-6 md:start-7 text-white md:text-black text-2xl md:text-3xl font-bold z-10">
            {t.smileGalleryHeading}
          </h3>
          <p className="absolute bottom-4 start-5 md:bottom-6 md:start-7 text-white md:text-black text-xs md:text-sm font-semibold z-10">
        ...
        >
          <p className="absolute bottom-16 start-5 md:bottom-20 md:start-7 text-white text-xs md:text-sm font-semibold leading-4 md:leading-5 z-10">
            {t.smileCard1Line1}
            <br />
            {t.smileCard1Line2}
          </p>
        ...
        >
          <h3 className="absolute top-4 start-5 md:top-6 md:start-7 text-white md:text-black text-[clamp(2.5rem,7vw,6rem)] font-bold leading-[0.9] z-10">
            {t.makeoverLine1}
            <br />
            {t.makeoverLine2}
          </h3>
        ...
        >
          <div className="absolute inset-0 z-10 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-1.5 md:gap-2 p-2 md:p-3 overflow-y-auto">
            {t.services.map((svc, i) => (
              <div
                key={svc.name}
                className="rounded-lg md:rounded-xl bg-white/90 backdrop-blur-md p-2.5 md:p-4 flex flex-col justify-between"
              >
